    ...
    // 定义语言映射对象
    const langMap = {
        'zhtw': (globalThis && globalThis.website && globalThis.website.zhtw) ? globalThis.website.zhtw : globalThis._getJSONKey('zh-tw', langJSON),
'en': (globalThis && globalThis.website && globalThis.website.en) ? globalThis.website.en : globalThis._getJSONKey('en', langJSON),
'ja': (globalThis && globalThis.website && globalThis.website.ja) ? globalThis.website.ja : globalThis._getJSONKey('ja', langJSON),
'ko': (globalThis && globalThis.website && globalThis.website.ko) ? globalThis.website.ko : globalThis._getJSONKey('ko', langJSON),
'ru': (globalThis && globalThis.website && globalThis.website.ru) ? globalThis.website.ru : globalThis._getJSONKey('ru', langJSON),
'fr': (globalThis && globalThis.website && globalThis.website.fr) ? globalThis.website.fr : globalThis._getJSONKey('fr', langJSON),
'zhcn': (globalThis && globalThis.website && globalThis.website.zhcn) ? globalThis.website.zhcn : globalThis._getJSONKey('zh-cn', langJSON)
    };
    ...
    isFunction(globalThis.localStorage.getItem) && globalThis.localStorage.getItem('website');
    ...
    const baseLang = withStorageLang ? globalThis.localStorage.getItem('website') : 'zhcn';
    const lang = commonLang ? commonLang : baseLang;
    // 根据当前语言设置翻译函数的语言包
    globalThis.$t.locale(globalThis.langMap[lang], 'website');
